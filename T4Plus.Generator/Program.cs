...
namespace T4Plus.Generator
{
    internal class Program
    {
        ...
        private const string GeneratorMethodName = "Generate";
        ...
        private static int Main(string[] args)
        {
            if (args.Length != 2)
            {
                ...
                return 1;
                //TODO demo purpose
                //dllFilepath = @"C:\PROJECTS\T4Plus\DemoProject\bin\Debug\net5.0\DemoProject.dll";
                //outputFilePath = @"C:\PROJECTS\T4Plus\DemoProject\AutoGeneratedClass.cs";
            }
        ...
        private static bool ProcessType(IndentedTextWriter writer, Type type)
        {
            ...
            foreach (var attribute in attributes)
            {
                var method = attribute.GetType().GetMethods().FirstOrDefault(x =>
                    x.Name.Equals(GeneratorMethodName, StringComparison.InvariantCultureIgnoreCase));
                if (method != null)
                {
